...
$mensaje.="</td></tr>
		...
		"IMPORTANT/ CONFIDENTIAL<br>
        This document contains personal and confidential information that is directed solely and exclusively to its recipient and, according to law, cannot be disseminated. It is completely prohibited to make copies, partial or total, as well as to propagate its content to people other than the recipient. If you received this message in error, please inform the sender and dispose of any documents immediately. This quote has been issued at ". strftime("%H:%M %p") ."</div>";
